...
def load_data(data_path: str = "heart_disease_data/processed.cleveland.data") -> pd.DataFrame:
    """
...
def convert_target_to_binary(df: pd.DataFrame) -> pd.DataFrame:
    ...
    logger.info(f"Target distribution: 0 (No Disease): {class_counts.get(0, 0)}, "
